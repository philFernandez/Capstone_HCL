  ...
  <body>
    ...
    <nav class="navbar navbar-dark bg-dark">
      <div class="container-fluid">
        <span class="navbar-text navbar-brand pb-1 pt-1"
          >Lee's Music Store</span
        >
      </div>
    </nav>
    <div class="container">

      <h1 class="display-3 pb-5 pt-3" align="center">Register</h1>
      <form:form modelAttribute="user" class="form-control p-4">
        ...
        <form:input placeholder="johndoe@example.com" path="email" type="text" class="form-control" required="required" />
        <br><br>
